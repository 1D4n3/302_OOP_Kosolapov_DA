...
class StudentsListTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->student1->setLastname('Kosolapov')->setName('Daniil')->setFaculty('IT')->setCourse(2)->setGroup(302);
        $this->student2 = new Student();
        $this->student2->setLastname('Oshina')->setName('Natalia')->setFaculty('IT')->setCourse(2)->setGroup(302);
        $this->student3 = new Student();
        $this->student3->setLastname('Minin')->setName('Dmitry')->setFaculty('IT')->setCourse(2)->setGroup(302);
    }
